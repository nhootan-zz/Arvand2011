...
private:
	...
	int last_local_improving_walk; // the last local walk that decreased heuristic
	int num_nonwasted_walks;   // the total number of walks that are run before last local improvements
	int total_min;
	int num_episodes;
	double avg_speed;
