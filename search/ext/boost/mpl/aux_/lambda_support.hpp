...
#define BOOST_MPL_AUX_LAMBDA_SUPPORT(i, name, params)                          \
  ...
  BOOST_PP_LIST_FOR_EACH_I_R(1, BOOST_MPL_AUX_LAMBDA_SUPPORT_ARG_TYPEDEF_FUNC, \
                             typedef, BOOST_PP_TUPLE_TO_LIST(i, params))       \
  struct rebind {                                                              \
    template <BOOST_MPL_PP_PARAMS(i, typename U)>                              \
    struct apply : name<BOOST_MPL_PP_PARAMS(i, U)> {};                         \
  };                                                                           \
  /**/
...
#elif BOOST_WORKAROUND(__EDG_VERSION__, <= 244) && \
...
#define BOOST_MPL_AUX_LAMBDA_SUPPORT_HAS_REBIND(i, name, params)               \
  template <BOOST_MPL_PP_PARAMS(i, typename T)>                                \
  ::boost::mpl::aux::yes_tag operator|(::boost::mpl::aux::has_rebind_tag<int>, \
