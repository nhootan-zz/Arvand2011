...
#define BOOST_TT_AUX_TYPE_TRAIT_PARTIAL_SPEC1_2(param1, param2, trait, spec, \
                                                result)                      \
...
#define BOOST_TT_AUX_TYPE_TRAIT_IMPL_PARTIAL_SPEC1_1(param, trait, spec, \
                                                     result)             \
  template <param>                                                       \
  struct trait##_impl<spec> {                                            \
    typedef result type;                                                 \
