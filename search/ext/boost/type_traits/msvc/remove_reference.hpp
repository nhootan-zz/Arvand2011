...
struct remove_reference_impl_typeof<true> {
  ...
  struct inner {
    ...
    BOOST_STATIC_CONSTANT(unsigned,
                          register_test = sizeof(test((T(*)())(NULL))));
...
struct remove_reference {
  typedef
      typename boost::detail::remove_reference_impl_typeof<boost::is_reference<
          T>::value>::template inner<T, remove_reference<T> >::type type;
