...
#if !defined(_GLIBCPP_USE_LONG_LONG) && !defined(_GLIBCXX_USE_LONG_LONG) && \
...
#undef BOOST_HAS_LONG_LONG
    ...
    (defined(__GLIBCPP__) && __GLIBCPP__ >= 20020514)  // GCC >= 3.1.0
...
//  stdlibc++ developers. He also commented:
//
...
//       20080305. Although 4.3.0 was released earlier than 4.2.4, it has better
//       C++0x support than any release in the 4.2 series."
//
