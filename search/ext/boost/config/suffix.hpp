...
// -------------------------------------// Normally evaluates to nothing, unless
// BOOST_NO_UNREACHABLE_RETURN_DETECTION is defined, in which case it evaluates
// to return x; Use when you have a return statement that can never be reached.
