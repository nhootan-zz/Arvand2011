...
//
#if defined(__GNUC__) && \
    ((__GNUC__ < 3) || (__GNUC_MINOR__ <= 3) || !defined(BOOST_STRICT_CONFIG))
//
// this is checked up to gcc 3.3:
//
#if defined(__sgi) || defined(__hpux)
#error \
    "Multi-threaded programs are not supported by gcc on HPUX or Irix (last checked with gcc 3.3)"
#endif
...
#else
#error \
    "Compiler threading support is not turned on. Please set the correct command line options for threading: -openmp"
#endif
...
//  Borland
#error \
    "Compiler threading support is not turned on. Please set the correct command line options for threading: -tWM"
...
#error \
    "Compiler threading support is not turned on. Please set the correct command line options for threading: -mt"
...
//  IBM Visual Age
#error \
    "Compiler threading support is not turned on. Please compile the code with the xlC_r compiler"
