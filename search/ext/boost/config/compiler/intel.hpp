...
// Particularly /Qoption,c,--arg_dep_lookup (reported by Kirk Klobe & Thomas
// Witt) and /Zc:wchar_t,forScope. See
// boost-root/tools/build/intel-win32-tools.jam for details as they apply to
// particular versions of the compiler. When the compiler does not predefine a
// macro indicating if an option has been set, this config file simply assumes
// the option has been set. Thus BOOST_NO_ARGUMENT_DEPENDENT_LOOKUP will not be
// defined, even if the compiler option is not enabled.
