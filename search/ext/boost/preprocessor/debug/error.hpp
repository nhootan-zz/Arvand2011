...
#endif
#
#define BOOST_PP_ERROR_0x0000 \
  BOOST_PP_ERROR(0x0000, BOOST_PP_INDEX_OUT_OF_BOUNDS)
...
#define BOOST_PP_ERROR_0x0004 \
  BOOST_PP_ERROR(0x0004, BOOST_PP_LIST_FOLD_OVERFLOW)
#define BOOST_PP_ERROR_0x0005 BOOST_PP_ERROR(0x0005, BOOST_PP_SEQ_FOLD_OVERFLOW)
#define BOOST_PP_ERROR_0x0006 \
  BOOST_PP_ERROR(0x0006, BOOST_PP_ARITHMETIC_OVERFLOW)
