...
class SearchProgress {
 private:
  ...
  int generated_states;  // nr states created in total (plus those removed since
  ...
  int lastjump_expanded_states;  // same guy but at point where the last jump in
                                 // the open list
  int lastjump_reopened_states;  // occured (jump == f-value of the first node
