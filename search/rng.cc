...
RandomNumberGenerator::RandomNumberGenerator(int s) { seed(s); }

RandomNumberGenerator::RandomNumberGenerator(unsigned int *init_key,
                                             int key_length) {
...
int RandomNumberGenerator::next31() { return static_cast<int>(next32() >> 1); }
