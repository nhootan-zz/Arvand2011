...
IteratedSearch::IteratedSearch(const Options &opts)
    : SearchEngine(opts),
      ...
      postprocessing(opts.get<bool>("postprocessing")) {
...
static SearchEngine *_parse(OptionParser &parser) {
  ...
  parser.add_option<bool>("pass_bound", true, "use bound from previous search");
  parser.add_option<bool>("repeat_last", false, "repeat last phase of search");
