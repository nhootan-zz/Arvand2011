...
ArtificialHeuristic::ArtificialHeuristic(const Options &opts) :  Heuristic(opts) {
...
static ScalarEvaluator *_parse(OptionParser &parser) {
    parser.add_option<double>("h_deviation_factor", DEFAULT_HD, "the heuristic deviation factor");
